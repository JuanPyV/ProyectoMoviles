...
import com.example.traverio.Dialogs.InfoMapDialog;
import com.example.traverio.Dialogs.InfoPlaceDialog;
import com.example.traverio.AuxiliaryClasses.MarkerPlaceInformation;
import com.example.traverio.AuxiliaryClasses.PlaceInformation;
           ...
           for (int i = 0; i < markers.size(); i++){
               if (markers.get(i).getMarker().equals(marker)){
                   ...
                   dialogInfoMap.newInstance(
                           ...
                           placeInformation.getDescription(),
                           average,
