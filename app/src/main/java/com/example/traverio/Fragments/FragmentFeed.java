package com.example.traverio.Fragments;
...
import com.example.traverio.Adapters.AdapterFeed;
import com.example.traverio.AuxiliaryClasses.ModelFeed;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(userData != null){
                    ...
                    ModelFeed newPost = new ModelFeed(userData.getFirstName() + userData.getLastName() , statusUpdateF.getText().toString(), date.toString(),
                            userData.getProfilePicURL() + "", imageURL.getText().toString() + "", user.getUid());
                    GenericTypeIndicator<List<ModelFeed>> t = new GenericTypeIndicator<List<ModelFeed>>() {
                        @Override
                        public int hashCode() {
                            return super.hashCode();
                    ...
                    Toast.makeText(getActivity(), "You have to set up your profile information before making a post", Toast.LENGTH_SHORT).show();
                }
            }
