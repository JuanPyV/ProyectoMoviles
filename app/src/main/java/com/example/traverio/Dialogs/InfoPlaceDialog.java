package com.example.traverio.Dialogs;
...
import com.example.traverio.Fragments.FragmentMap;
    ...
    public void addPlace(){
        ...
        if (title2.equals("") || description2.equals("") || lon2.equals("") ||
            ...
            try{
                ...
                e.printStackTrace();
                Toast.makeText(getActivity(), "Both latitude and longitude most be numbers, enter a valid number.", Toast.LENGTH_SHORT).show();
            }
        }
    }
